...
#+BEGIN_SRC python :noweb yes :results output 
  ...
  initial_gen( 10, "/home/jake/org/Thesis_Stuff/2015-11-11-preliminary-robo-experiments/Random_No_Development/Gen1")
  gen = 1
  while (gen < 11):
...
* Generate single alternate organism
#+BEGIN_SRC python :noweb yes :tangle OrganismTest.py :results output
  from AlternateOrganism import *
