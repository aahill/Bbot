...
#+BEGIN_SRC python :noweb yes :results output pp 
  ...
  def initial_gen(number_of_orgs, path):
      ...
      while orgs < number_of_orgs:
          org = Organism.Organism(1, orgs,2100,4,True,300)
          if org.is_viable():
              ...
              print "-------------------------------------//"
          tested += 1
          #progress(tested_gen(10, "/home/jake/Dropbox/BraitenbotCode/Summer2015/2015-07-22- EvolvingThreadNumber/coding_region_300/Double_Crossover_2/Gen1")

  initial_gen( 10, "/home/jake/org/Thesis_Stuff/Simulation_Data/coding_region_300/Double_Crossover_2/Gen1")
  gen = 1
  while (gen < 11):
      path1 = "/home/jake/org/Thesis_Stuff/Simulation_Data/coding_region_300/Double_Crossover_2/Gen"+str(gen)
      path2 = "/home/jake/org/Thesis_Stuff/Simulation_Data/coding_region_300/Double_Crossover_2/Gen"+str(gen+1)
      thresholdedCrossGeneration("/home/jake/org/Thesis_Stuff/Simulation_Data/coding_region_300/Double_Crossover_2", path1, path2)
      gen+=1
