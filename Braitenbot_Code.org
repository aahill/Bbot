  ...
  def initial_gen(number_of_orgs, path):
      ...
      #Organism params in order: generation, generational index, genome_len, num crossover points
          ...
          if org.is_viable():
              ...
              print "-------------------------------------//"
          tested += 1
          #progress(tested_gen(10, "/home/jake/Dropbox/BraitenbotCode/Summer2015/2015-07-22- EvolvingThreadNumber/coding_region_300/More_Mutation_3/Gen1")

  initial_gen( 10, "/home/jake/org/Thesis_Stuff/2015-11-11-preliminary-robo-experiments/Random_Development/Gen1")
  gen = 1
  while (gen < 11):
      path1 = "/home/jake/org/Thesis_Stuff/Simulation_Data/coding_region_300/D1/More_Mutation_3/Gen"+str(gen)
      path2 = "/home/jake/org/Thesis_Stuff/Simulation_Data/coding_region_300/D1/More_Mutation_3/Gen"+str(gen+1)
     # thresholdedCrossGeneration("/home/jake/org/Thesis_Stuff/Simulation_Data/coding_region_300/D1/More_Mutation_3", path1, path2)
      gen+=1
