...
#+BEGIN_SRC python :results output
  ...
  path = "/home/jake/org/Thesis_Stuff/Robot_Data"
  while(counter < 10):
      org = Organism.Organism(1, counter, 560, 2, True, 80, 2000)
      if org.is_viable():
          org.save_to_file(path+"/Development/Gen1")
          org_no_devo =  AlternateOrganism.Organism(1, counter, 560, 2, True, 80, 2000, None, None, org.genome)
          org_no_devo.save_to_file(path+"/No_Development/Gen1")
          assert(org.genome == org_no_devo.genome)
          ...
          print "NO DEVO"
          for thread in org_no_devo.threads:
              print [i.group_id for i in thread.connected_pins]
              print "new thread connections:"
              for connection in thread.connected_pins:
                  print connection.group_id, connection.number
